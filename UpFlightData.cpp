...
//     for(const auto& s : updatedFlights)
//     {
// cout<<s.flightNumber<<" "<<s.departureAirport<<" "<<s.departureDate<<" "<<s.departureTime<<" "<<s.arrivalAirport<<" "<<s.arrivalDate<<" "<<s.arrivalTime<<" "<<s.aircraftType<<endl;
//     }
